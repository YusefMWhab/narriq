...
function setupPageEvents() {
    ...
    if (codeSearchInput) {
        codeSearchInput.addEventListener('input', applyCodeBookFilter);
    }
...
function renderColumnData(columnName) {
    ...
    if (responsesSearchInput || ResponsesShowEmptyToggle.checked) {
        applyResponsesFilter();
    }
...
function applyCodeBookFilter() {
            const searchText = codeSearchInput.value.toLowerCase().trim();
